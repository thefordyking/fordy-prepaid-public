 ...
 */
export declare class ListTransactionsRequest extends GetEndpoint {
    path: string;
    params: ListTransactionsParams;
    constructor(params?: ListTransactionsParams);
}
/**
...
export declare type ListTransactionsResponse = GetRequestPaginatedResponse<Transaction>;
